...
function PredictionForm({
  ...
  // Generate supported crop years: 1997 to 2019
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <CustomSelect
                ...
                placeholder="Search or select a crop"
              />
            </div>
            ...
            <div className="form-group">
              ...
              <CustomSelect
                ...
                placeholder="Search or select a season"
              />
            </div>
            ...
            <div className="form-group">
              ...
              <CustomSelect
                name="Crop_Year"
                value={String(formData.Crop_Year || "")}
                onChange={handleChange}
                options={years}
              ...
              <small>
                Select a year between 1997 and 2026.
              </small>
            </div>
